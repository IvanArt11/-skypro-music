...
const TracksAll = () => {
  ...
  React.useEffect(() => {
    if (initialPlaylist) {
      ...
      if (filtersState.years === 'Сначала новые') {
        filterPlaylist.sort((a, b) => sortYears(b.release_date, a.release_date))
      } else if (filtersState.years === 'Сначала старые') {
        filterPlaylist.sort((a, b) => sortYears(a.release_date, b.release_date))
  ...
  }, [filtersState.years, dispatch, initialPlaylist])
